...
export const copy = {
  metadata: {
    title: "1000 Egészséges Recept 2.0",
    description:
    ...
    items: [
      {
        ...
        desc: "Rengeteg kiegyensúlyozott és tápláló recept az ebédektől a vacsorákig, beleértve az egészséges házi szószokat és krémeket is.",
      },
      {
        icon: "BookOpen",
    ...
    items: [
      {
        ...
        tag: "1. BÓNUSZ",
        title: "E-könyv: 100 Egészséges Leves",
        desc: "100 szénhidrátszegény, melegítő leves receptje.",
        value: "4 990 Ft",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "2. BÓNUSZ",
        title: "E-könyv: 67 Egészséges Turmix",
        desc: "67 frissítő, cukormentes turmix ötlet.",
        value: "4 990 Ft",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "3. BÓNUSZ",
        title: "E-könyv: 100 Egészséges Snack",
        desc: "100 gyors és egészséges nassolnivaló cukorbetegeknek.",
        value: "4 990 Ft",
      },
      {
  ...
  finalCta: {
    ...
    headline:
      "SZEREZD MEG A DIGITÁLIS KÖNYVET MA, ÓRIÁSI KEDVEZMÉNNYEL!",
    subUrgency:
    ...
    bundleList: [
      ...
      "1. Bónusz — 100 Egészséges Leves",
      "2. Bónusz — 67 Egészséges Turmix",
      "3. Bónusz — 100 Egészséges Snack",
  ...
  faq: {
    authorRole: "Horváth Katalin Séf és a Táplálkozási Csapat",
    authorHeadline: "Finom ételek, amelyek vigyáznak az egészségedre",
    authorBio:
      "Hiszünk abban, hogy a cukorbetegség nem veheti el az étkezés örömét. Minden egyes receptünket úgy alkottuk meg, hogy bűntudat nélkül élvezhesd az ízeket, miközben a vércukorszintedet is kordában tartod.",
    authorImageAlt: "A csapatunk",
